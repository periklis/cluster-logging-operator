...
func (clusterRequest *ClusterLoggingRequest) includeLegacyForwardConfig() bool {
	if clusterRequest.CLFVerifier.FnIncludeLegacyForward != nil {
		return clusterRequest.CLFVerifier.FnIncludeLegacySyslog()
	}
	config := &v1.ConfigMap{
...
func (clusterRequest *ClusterLoggingRequest) includeLegacySyslogConfig() bool {
	if clusterRequest.CLFVerifier.FnIncludeLegacySyslog != nil {
		return clusterRequest.CLFVerifier.FnIncludeLegacySyslog()
	}
	config := &v1.ConfigMap{
		Data: map[string]string{},
